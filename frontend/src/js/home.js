...
window.addEventListener('load', async event => {
    ...
    var createScene = function () {            
        ...
        let stop = false;
        BABYLON.SceneLoader.ImportMesh("", "https://bafybeiav5dvtpws4vmegajter4y5rk2et64ct4goohjl3vejnewyqk7iuq.ipfs.w3s.link/ipfs/bafybeiav5dvtpws4vmegajter4y5rk2et64ct4goohjl3vejnewyqk7iuq/", "intro.glb", scene, function (newMeshes, particleSystems, skeletons, animationGroups) {
